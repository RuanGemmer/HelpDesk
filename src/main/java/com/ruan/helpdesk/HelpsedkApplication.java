...
public class HelpsedkApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Chamado c1 = new Chamado(null, Prioridade.MEDIA, Status.ANDAMENTO, "Chamado 001", "Primeiro Chamado", tec1, cli1);
